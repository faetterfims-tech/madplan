...
const PRICE_TABLE = {
  ...
  'forårsløg':          [12, 1, 'flat'],
  // Pantry — Bilka-pris per indkøb (én flaske/pose/krukke/bundt)
  'olie':               [28, 1, 'flat'],
  'olivenolie':         [60, 1, 'flat'],
  'rapsolie':           [28, 1, 'flat'],
  'sesamolie':          [45, 1, 'flat'],
  'sojasauce':          [30, 1, 'flat'],
  'hvidvin':            [10, 100, 'ml'],
  ...
  'honning':            [28, 1, 'flat'],
  'sennep':             [18, 1, 'flat'],
  'mayonnaise':         [25, 1, 'flat'],
  'ketchup':            [22, 1, 'flat'],
  'remoulade':          [28, 1, 'flat'],
  'salsa':              [25, 1, 'flat'],
  'pesto':              [38, 1, 'flat'],
  'tahini':             [35, 1, 'flat'],
  'bearnaisesauce':     [42, 1, 'flat'],
  'hollandaisesauce':   [42, 1, 'flat'],
  'vaniljesovs':        [25, 1, 'flat'],
  'bbq-sauce':          [30, 1, 'flat'],
  'bouillon':           [20, 1, 'flat'],
  ...
  'pinjekerner':        [35, 50, 'g'],
  'espresso':           [28, 1, 'flat'],
  'kakaopulver':        [25, 1, 'flat'],
  // Tilføjet for nye opskrifter — Bilka-indkøbspriser maj 2026
  'havregryn':          [18, 1, 'flat'],
  'rasp':               [18, 1, 'flat'],
  'maizena':            [18, 1, 'flat'],
  'worcestershire sauce': [28, 1, 'flat'],
  'balsamicoeddike':    [35, 1, 'flat'],
  'soltørrede tomater': [30, 100, 'g'],
  'syltede agurker':    [28, 1, 'flat'],
  'syltede rødbeder':   [22, 1, 'flat'],
  'brun farin':         [14, 1, 'flat'],
  'røget paprika':      [14, 1, 'flat'],
  'mango':              [22, 1, 'stk'],
  'spidskommen':        [14, 1, 'flat'],
  'kardemomme':         [14, 1, 'flat'],
  'nelliker':           [12, 1, 'flat'],
  'koriander':          [14, 1, 'flat'],
  'laurbær':            [12, 1, 'flat'],
  'oregano':            [12, 1, 'flat'],
  ...
  'chorizo':            [50, 150, 'g'],
  'rød karrypasta':     [22, 1, 'flat'],
  'dijonsennep':        [22, 1, 'flat'],
  'pastinak':           [10, 1, 'stk'],
  ...
  'hvidløgspulver':     [12, 1, 'flat'],
  'løgpulver':          [12, 1, 'flat'],
  'cayennepeber':       [12, 1, 'flat'],
  'gurkemeje':          [12, 1, 'flat'],
  'garam masala':       [14, 1, 'flat'],
  'allehånde':          [12, 1, 'flat'],
  'fladbrød':           [25, 1, 'flat'],
  'basmatiris':         [28, 1000, 'g'],
  'teriyakisauce':      [35, 1, 'flat'],
  'fishsauce':          [28, 1, 'flat'],
  'edamamebønner':      [32, 200, 'g'],
  'rugmel':             [18, 1, 'flat'],
  'hampefrø':           [35, 1, 'flat'],
  'valnødder':          [38, 100, 'g'],
  'fennikelfrø':        [12, 1, 'flat'],
  ...
  'riseddike':          [25, 1, 'flat'],
  'sesamfrø':           [18, 1, 'flat'],
  'vaniljepulver':      [10, 1, 'flat'],
  'græskarkerner':      [18, 100, 'g'],
  'wienerpølser':       [32, 6, 'stk'],
  'rucola':             [25, 100, 'g'],
  'pickles':            [22, 1, 'flat'],
  'æblecidereddike':    [28, 1, 'flat'],
  ...
  // c011-c020
  'grahamsmel':         [15, 1, 'flat'],
  'knoldselleri':       [35, 1, 'stk'],
  'chilipulver':        [12, 1, 'flat'],
  'majskerner':         [16, 340, 'g'],
  'grøntsagsbouillon':  [20, 1, 'flat'],
  'hønsebouillon':      [20, 1, 'flat'],
  'oksebouillon':       [20, 1, 'flat'],
  'muskat':             [14, 1, 'flat'],
  'muskatnød':          [14, 1, 'flat'],
  'paprika':            [12, 1, 'flat'],
  'sød paprika':        [12, 1, 'flat'],
  'stødt paprika':      [12, 1, 'flat'],
  'rugbrødsskiver':     [30, 1, 'flat'],
  'rødspættefileter':   [88, 400, 'g'],
  'tortilla':           [25, 1, 'flat'],
  'mangosalsa':         [25, 1, 'flat'],
  'majsstivelse':       [12, 1, 'flat'],
